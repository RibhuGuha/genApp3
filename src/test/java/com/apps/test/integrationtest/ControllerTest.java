...
class ControllerTest {
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test.Trips");
    jdbcTemplate.execute("DELETE FROM test.Person");
     jdbcTemplate.execute("DELETE FROM test.PersonFriends");
     jdbcTemplate.execute("DELETE FROM test.PersonTrip");
